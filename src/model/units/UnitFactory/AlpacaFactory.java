...
public class AlpacaFactory extends AbstractUnitFactory{
     ...
     * @param items
     */
    protected AlpacaFactory(int hitPoints, int movement, Location location, int maxItems, Tactician tactician, IEquipableItem... items) {
        super(hitPoints, movement, location, maxItems, tactician, items);
    }

    @Override
    public IUnit create() {
        IUnit unit = new Alpaca(hitPoints,movement,location);
