...
public class FighterFactory extends AbstractUnitFactory {
     ...
     * @param items
     */
    protected FighterFactory(int hitPoints, int movement, Location location, int maxItems, Tactician tactician, IEquipableItem... items) {
        super(hitPoints, movement, location, maxItems, tactician, items);
    }

    @Override
    public IUnit create() {
        IUnit unit = new Fighter(hitPoints,movement,location);
