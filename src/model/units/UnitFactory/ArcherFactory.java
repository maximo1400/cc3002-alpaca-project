...
public class ArcherFactory extends AbstractUnitFactory {
     ...
     * @param items
     */
    protected ArcherFactory(int hitPoints, int movement, Location location, int maxItems, Tactician tactician, IEquipableItem... items) {
        super(hitPoints, movement, location, maxItems, tactician, items);
    }

    @Override
    public IUnit create() {
        IUnit unit = new Archer(hitPoints,movement,location);
