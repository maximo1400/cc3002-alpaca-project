...
public class SorcererFactory extends AbstractUnitFactory {
     ...
     * @param items
     */
    protected SorcererFactory(int hitPoints, int movement, Location location, int maxItems, Tactician tactician, IEquipableItem... items) {
        super(hitPoints, movement, location, maxItems, tactician, items);
    }

    @Override
    public IUnit create() {
        IUnit unit = new Sorcerer(hitPoints,movement,location);
