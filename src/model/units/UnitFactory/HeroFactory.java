...
public class HeroFactory extends AbstractUnitFactory {
     ...
     * @param items
     */
    protected HeroFactory(int hitPoints, int movement, Location location, int maxItems, Tactician tactician, IEquipableItem... items) {
        super(hitPoints, movement, location, maxItems, tactician, items);
    }

    @Override
    public IUnit create() {
        IUnit unit = new Hero(hitPoints,movement,location);
