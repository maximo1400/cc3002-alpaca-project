...
public class ClericFactory extends AbstractUnitFactory {
     ...
     * @param items
     */
    protected ClericFactory(int hitPoints, int movement, Location location, int maxItems, Tactician tactician, IEquipableItem... items) {
        super(hitPoints, movement, location, maxItems, tactician, items);
    }

    @Override
    public IUnit create() {
        IUnit unit = new Cleric(hitPoints,movement,location);
